...
# Aziro Cluster Center - VM Management Test Runner
# This script runs ONLY the VM management test cases

echo "=========================================="
echo "Aziro Cluster Center - VM Management Tests"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "Running VM Management Tests Only (HEADED MODE)"
echo "=========================================="
echo ""

# Run ONLY VM management tests in headed mode
pytest tests/test_vm_management.py \
    --headed \
    --browser chromium \
    --slowmo 500 \
    -v \
...
echo ""
echo "=========================================="
echo "VM Management Test Execution Complete"
echo "=========================================="
echo ""

if [ $TEST_EXIT_CODE -eq 0 ]; then
    echo -e "${GREEN}✓ All VM management tests passed!${NC}"
else
    echo -e "${RED}✗ Some VM management tests failed. Check the report for details.${NC}"
fi
