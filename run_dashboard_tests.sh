...
# Aziro Cluster Center - Dashboard Test Runner
# This script runs ONLY the dashboard test cases

echo "=========================================="
echo "Aziro Cluster Center - Dashboard Tests"
echo "=========================================="
echo ""
...
echo ""
echo "=========================================="
echo "Running Dashboard Tests Only (HEADED MODE)"
echo "=========================================="
echo ""

# Run ONLY dashboard tests in headed mode
...
echo ""
echo "=========================================="
echo "Dashboard Test Execution Complete"
echo "=========================================="
echo ""
...
if [ $TEST_EXIT_CODE -eq 0 ]; then
    ...
    echo -e "${RED}✗ Some dashboard tests failed. Check the report for details.${NC}"
fi
